<template>
    <div class="ui basic segment" style="font-size:1.1em;">
        <h1 class="ui header">Heart Rating Component</h1>
        <div class="ui divider"></div>

        <p>The heart-rating component is included out of the box and requires minimal markup and like all vue-rate-it components is highly customisable: </p>
        ...
        <p>Using the heart-rating component via NPM is simple, once vue-rate-it has been installed you simply need to import it into your component:</p>

        <div class="ui segment">
            <!-- HTML generated using hilite.me -->
            <div style="background: #ffffff; overflow:auto;width:auto;;border-width:.1em .1em .1em .8em;padding:.2em .6em;"><pre style="margin: 0; line-height: 125%"><span style="color: #0000aa">import</span> {HeartRating} from <span style="color: #aa5500">&#39;vue-rate-it&#39;</span>;
...
<span style="color: #0000aa">export</span> <span style="color: #0000aa">default</span>{
  components:{
    HeartRating
        ...
        <p>You may also include the heart-rating component via unpkg by adding the following to your page:</p>
        ...
        <p>The heart rating component includes the following props:</p>
        <table class="ui celled table">
            ...
            <tbody>
                <tr>
                    <td>increment</td>
                    <td>Number</td>
                    <td>The rating increment. For example pass 0.5 for half hearts or 0.01 for fluid hearts. Expects a number between 0.01 - 1.</td>
                    <td>1</td>
                </tr>
                <tr>
                    <td>rating</td>
                ...
                <tr>
                    <td>max-rating</td>
                    <td>Number</td>
                    <td>The maximum rating, this lets vue-rate-it know how many hearts to display.</td>
                    <td>5</td>
                </tr>
                <tr>
                    <td>inactive-color</td>
                    <td>String</td>
                    <td>Yhe color of the non-highlighted portion of a heart.</td>
                    <td>#ffc4c4</td>
                </tr>
                <tr>
                    <td>active-color</td>
                    <td>String</td>
                    <td>The color of the highlighted portion of a heart.</td>
                    <td>#d80000</td>
                </tr>
                <tr>
                    <td>item-size</td>
                    <td>Number</td>
                    <td>The size of each heart. This gets passed to the SVG width attribute, so larger numbers are larger hearts.</td>
                    <td>50</td>
                </tr>
                <tr>
                    <td>show-rating</td>
                    <td>Boolean</td>
                    <td>Whether or not to show the rating next to the hearts.</td>
                    <td>true</td>
                </tr>
                <tr>
                    <td>read-only</td>
                ...
                <tr>
                    <td>text-class</td>
                    <td>String</td>
                    <td>A css class name to style the rating text for a specific heart rating component</td>
                    <td>""</td>
                </tr>
                <tr>
                    <td>fixed-points</td>
                ...
                <tr>
                    <td>border-color</td>
                    <td>String</td>
                    <td>Sets the colour of the border for each heart.</td>
                    <td>#8b0000</td>
                </tr>
                <tr>
                    <td>border-width</td>
                    <td>Number</td>
                    <td>Sets the width of the border for each heart.</td>
                    <td>3</td>
                </tr>
                <tr>
                    <td>spacing</td>
